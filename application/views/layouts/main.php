        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-mini">Streaming river</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">Streaming river</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
						...
						<li>
                            <a href="<?php echo site_url('channel/index');?>">
                                <i class="fa fa-desktop"></i> <span>Channel</span>
                            </a>
                        </li>
						<li>
